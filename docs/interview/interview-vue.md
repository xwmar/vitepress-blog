...
![](http://pic.qigou.top/vue/image-20210223221853817.png)
...
![](http://pic.qigou.top/vue/image-20210224084130350.png)
...
![](http://pic.qigou.top/vue/image-20210309011422081.png)
...
![](http://pic.qigou.top/vue/image-20210309122823432.png)
...
![](http://pic.qigou.top/vue/image-20201208122803496.png)
![](http://pic.qigou.top/vue/image-20210309151257119.png)
...
3. diff 算法: 默认的对比(diff) 机制,  同层兄弟元素, 是按照下标进行对比的, 但是加了 key,  **就相当于给虚拟dom加了个标识**
  ...
  ![](http://pic.qigou.top/vue/image-20210309155633728.png)
...
4. 使用Phantomjs `针对爬虫` 做处理
   ...
   ![](http://pic.qigou.top/vue/image-20210309024213922.png)
...
3. 剩下的菜单权限控制，是相对复杂一些的
   ...
   (2) 用户登录进入首页时, 需要立刻发送请求, 获取个人信息 (包含权限的标识)
    ...
    ![](http://pic.qigou.top/vue/image-20210309031043592.png)
...
![](http://pic.qigou.top/vue/image-20210309032653781.png)

微信支付：需要自己根据后台返回的url生成二维码页面，如图所示

![](http://pic.qigou.top/vue/image-20210309032629631.png)
...
![](http://pic.qigou.top/vue/image-20210309172322244.png)
